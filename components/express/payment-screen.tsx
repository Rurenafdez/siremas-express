...
const METHODS = [
  {
    ...
    icon: CreditCard,
    title: "Visa •••• 4821",
    subtitle: "Tarjeta guardada",
  },
  { id: "new", icon: Plus, title: "Nueva tarjeta", subtitle: "Débito o crédito" },
  { id: "coupon", icon: Ticket, title: "Cupón La Sirena", subtitle: "Aplicar código" },
    ...
    <div className="flex h-full flex-col bg-background">
      <div className="bg-card">
        ...
        <header className="flex items-center gap-3 px-5 pb-3 pt-1">
          ...
          <h1 className="text-lg font-extrabold text-foreground">Pago</h1>
        </header>
      </div>
